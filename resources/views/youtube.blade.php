...
@section('main-content')
    <section id="menu">
      <div class="section-menu home">
        <ul>
          <li class="active"><a href="{{ route('youtube') }}"><i class="active fas fa-home"></i>Home</a></li>
      ...
      <div class="section-menu settings">
        <ul>
          ...
          <li><a href="#"><i class="fas fa-flag"></i>Cronologia e segn...</a></li>
